...
export const FACILITIES = {
  ...
  'turret': {
    ...
    hp: 600, damage: 40, range: 160, attackSpeed: 1.2,
    projectileSpeed: 380,
  ...
  'cannon': {
    ...
    hp: 400, damage: 120, range: 250, attackSpeed: 0.4,
    projectileSpeed: 500,
  ...
  'healer': {
    ...
    hp: 500, heal: 30, range: 120, attackSpeed: 0.8,
    cost: 300, color: '#06d6a0', radius: 16,
    desc: '治疗范围内英雄'
  },
  // 伤害放大器：光环效果，范围内英雄伤害+30%
  'amplifier': {
    id: 'amplifier', name: '伤害放大器', type: 'booster',
    hp: 300, damageBoost: 0.3, range: 140,
